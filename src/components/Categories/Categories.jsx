...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className='absolute cursor-pointer flex justify-center items-center top-[-110px] right-[20px] z-[999] w-[46px] h-[46px] rounded-full bg-[#F5F5F5]' onClick={onClick}>
      <a href="#">
        <FaArrowRight /></a>
    </div>
  );
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className='absolute cursor-pointer flex justify-center items-center top-[-110px] right-[80px] z-[999] w-[46px] h-[46px] rounded-full bg-[#F5F5F5]' onClick={onClick}>
      <a href="#">
        <FaArrowLeft /></a>
    </div>
  );
          ...
          <div className=' mt-[60px]'>
            ...
            <Slider {...settings}>
              <div className='flex gap-x-[30px]'>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  <div>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_13108_430)">
                      ...
                      <defs>
                        <clipPath id="clip0_13108_430">
                          <rect width="56" height="56" fill="white" />
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>Phones</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer flex flex-col group hover:bg-primary justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  <div>

                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_13108_953)">
                  ...
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>Computers</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  <div>
                    ...
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_13108_530)">
                  ...
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>SmartWatch</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  ...
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>Camera</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  <div>
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_13108_544)">
                        ...
                        <path d="M42 30.3333H39.6667C37.0893 30.3333 35 32.4227 35 35V42C35 44.5773 37.0893 46.6666 39.6667 46.6666H42C44.5773 46.6666 46.6667 44.5773 46.6667 42V35C46.6667 32.4227 44.5773 30.3333 42 30.3333Z" className='group-hover:stroke-white tranition-all duration-100' stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  ...
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>HeadPhones</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
                  <div>
                    ...
                    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_13108_58)">
                  ...
                  <p className='font-primary mt-4 group-hover:text-white transition-all duration-100'>Gaming</p>
                </div>
              </div>
              <div>
                <div className='w-[170px] cursor-pointer group hover:bg-primary transition-all duration-100 flex flex-col justify-center items-center border border-black/30 rounded py-[24px] px-[55px]'>
